...
int main(int argc, const char *argv[]) {
  ...
  eep[0x34 + (saveSlot*0x70)] = 0x41; // little endian magic
  eep[0x35 + (saveSlot*0x70)] = 0x44; // ^^^^^^^^^^^^^^^^^^^
  eep[0x36 + (saveSlot*0x70)] = (checksum & 0xFF);
  eep[0x37 + (saveSlot*0x70)] = ((checksum & 0xFF00) >> 8);
